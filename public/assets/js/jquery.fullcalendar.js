...
!function($) {
    ...
    CalendarApp.prototype.onEventClick = function (calEvent, jsEvent, view) {
        ...
        form.append("<div class='form-group'><input class='form-control' type='text' value='" + calEvent.title + "' readonly /></div>");
        
        // You can add more event details here like start time, end time, etc.
    ...
    CalendarApp.prototype.init = function() {
        ...
        .then(data => {
            ...
            var defaultEvents = data.map(eventData => {
                return {
                    title: eventData.title,
                    start: eventData.start, // Replace with the property name that holds the start date
                    end: eventData.end,     // Replace with the property name that holds the end date
                    allDay: eventData.allDay, // Replace with the property name for all-day events
                    className: eventData.className // Replace with the property name that holds the class name
                };
            });
