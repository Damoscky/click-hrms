                                                        ...
                                                        <div class="modal-btn delete-action">
                                                            <div class="row">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <a href="{{ route('client.shift.cancel', base64_encode($shift->id)) }}"
                                        ...
                                        <div id="edit_shift-{{ $shift->id }}" class="modal custom-modal fade"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="{{ route('client.shift.update', base64_encode($shift->id)) }}"
                                                            method="post">
                                                            {{ csrf_field() }}
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="card punch-status">
                                                                            <div class="card-body">
                                                                                <h5 class="card-title">
                                                                                    <small
                                                                                        class="text-muted">{{ $employeeShift->employee->first_name }}
                                                                                        {{ $employeeShift->employee->last_name }}</small>
                                                                                </h5>
                                                                                <div class="punch-det">
                                                                                    <h6>Date Assigned</h6>
                                                                                    <p>{{ Carbon\Carbon::parse($employeeShift->date)->format('j F, Y') }}
                                                                                    </p>
                                                                                </div>
